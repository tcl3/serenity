...
DaysAndTime balance_time(double hour, double minute, double second, double millisecond, double microsecond, double nanosecond)
{
    ...
    microsecond += AK::floor(nanosecond / 1000);
    ...
    millisecond += AK::floor(microsecond / 1000);
