...
WebIDL::ExceptionOr<u32> CSSGroupingRule::insert_rule(StringView rule, u32 index)
{
    ...
    m_child_rules->item(index)->set_parent_rule(this);
    return index;
}
