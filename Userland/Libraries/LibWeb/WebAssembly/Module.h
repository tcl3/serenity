...
public:
    ...
    NonnullRefPtr<CompiledWebAssemblyModule> compiled_module() const { return m_compiled_module; }

private:
    Module(JS::Realm&, NonnullRefPtr<CompiledWebAssemblyModule>);

    virtual void initialize(JS::Realm&) override;

    NonnullRefPtr<CompiledWebAssemblyModule> m_compiled_module;
};
