...
class WebAssemblyContext {
public:
    void add_module(NonnullRefPtr<CompiledWebAssemblyModule> module) { m_loaded_modules.append(module); }
...
private:
    ...
    Vector<NonnullRefPtr<CompiledWebAssemblyModule>> m_loaded_modules;
